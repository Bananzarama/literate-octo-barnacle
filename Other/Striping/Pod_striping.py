...
def pod_striping(pod_base=None,parent_pod=None,pod_numbers=32,pod_name_base=None,filename="./pc_clone_spec.json",
        set1="pc_clone_spec1",set2="pc_clone_spec2",set3="pc_clone_spec3",replacement=True):
...
if __name__ == '__main__':
     #pod_striping(pod_base=19000,parent_pod=119,pod_name_base="IOT_RaspberryPi_Pod-%02d")
